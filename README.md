...
O projeto surgiu da necessidade de facilitar o fluxo de trabalho de colaboradores que lidam diariamente com documentação em PDF, oferecendo recursos de organização, edição e marcação de conteúdo de forma simples e intuitiva.
...
Projeto desenvolvido em equipe sob supervisão do coordenador de estágio no CREMEPE.
